    ...
    <Router>
      ...
      <div className = "container">
        <Routes>
            ...
            element = {
              <div>
                ...
                <div style = {{display: 'flex', flexDirection: 'column', alignItems: 'center',  gap: '10px'}}>
                  ...
                  <Link to = "/flights_on_the_ground" style = {{ textDecoration: "none"}}>
                    <button className="btn btn-primary btn-lg" >Flights on the Ground</button>
                  </Link>
                </div>
          ...
          <Route path ="/flights_on_the_ground" element = {<Flights_On_Ground />}/>
        </Routes>
      </div>
